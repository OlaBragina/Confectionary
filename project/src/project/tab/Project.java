 ...
 */
    ...
    public Project(String string, String h, String work, int i, int i0, int i1) {
    ...
    public void setPrice(int price) {
        ...
        public String toString() {
            return String.format("(%d, %d)", this.shipher, this.name_product , this.view_product , this.size,this.price);
        }
    }
